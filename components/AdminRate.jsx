...
module.exports = function AdminRate({ title ,rate}) {
  ...
  return (
    <Layout title={title}>
      <div className="rate">
        {rate.map(el=> <div className="rateCard1">
          <form className="UpdateRate" action={`/api/adminRate/bdRate/${el.id}`}  data-id={el.id}>
            <div className="row">
              ...
              <div className="input">
                ...
                <input name="weekend" id="weekend" className="validate" required defaultValue={el.weekend}/>
              </div>
            </div>
            <div className="row">
              <div className="input">
                <div className="day off">Выходные</div>
                <input name="dayOff" id="dayOff" className="validate" required defaultValue={el.dayOff} />
              </div>
            </div>
